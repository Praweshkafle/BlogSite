...
(function () {
            ...
            $: function (a) { a = a || {}; this.width = a.width; this.style = a.style; this.color = a.color; this._.normalize() }, _: {
                ...
                fromCssRule: function (a) {
                    ...
                    b = b || {}; var c = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (c, f) { var k = a["border-" + f] || b[f]; c[f] = k ? CKEDITOR.tools.style.parse.sideShorthand(k) : null; return c }, {}); return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function (b, f) {
                        var k = {}, l; for (l in c) {
                            var e =
                                a["border-" + f + "-" + l]; k[l] = e ? e : c[l] && c[l][f]
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, e, d) {
            ...
            } a.optimizeBookmark(); var h = 0 === b, l = 1 == b, q = 2 == b; b = q || l; var p = a.startContainer, u = a.endContainer,
                K = a.startOffset, E = a.endOffset, z, t, D, C, I, T; if (q && u.type == CKEDITOR.NODE_TEXT && (p.equals(u) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(u))) c.append(a.document.createText(u.substring(K, E))); else {
                    u.type == CKEDITOR.NODE_TEXT ? q ? T = !0 : u = u.split(E) : 0 < u.getChildCount() ? E >= u.getChildCount() ? (u = u.getChild(E - 1), t = !0) : u = u.getChild(E) : C = t = !0; p.type == CKEDITOR.NODE_TEXT ? q ? I = !0 : p.split(K) : 0 < p.getChildCount() ? 0 === K ? (p = p.getChild(K), z = !0) : p = p.getChild(K - 1) : D = z = !0; for (var N = p.getParents(), x = u.getParents(), H = m(),
